...
public class DtoMapper {
    ...
    public CambioEstadoTarea toModel(com.nuevospa.gestiontareas.dto.generated.CambioEstadoTarea dto) {
        if (dto == null) return null;
        
        CambioEstadoTarea model = new CambioEstadoTarea();
        model.setEstadoId(dto.getEstadoId());
        return model;
    }

    public com.nuevospa.gestiontareas.dto.generated.CambioEstadoTarea toDto(CambioEstadoTarea model) {
    ...
    public LoginRequest toModel(com.nuevospa.gestiontareas.dto.generated.LoginRequest dto) {
        if (dto == null) return null;
    ...
    public com.nuevospa.gestiontareas.dto.generated.LoginRequest toDto(LoginRequest model) {
        if (model == null) return null;
    ...
    public com.nuevospa.gestiontareas.dto.generated.LoginResponse toDto(LoginResponse model) {
        if (model == null) return null;
